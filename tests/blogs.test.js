...
describe('When logged in', async () => {
    ...
    describe('And using valid inputs', async () => 
    {
        ...
        test('Confirm post entries page', async () => 
        {
            const text = await page.getContentsOf('h5');
            expect(text).toEqual('Please confirm your entries');
        });

        test('Succesful blog submission', async () => 
        {
    ...
    describe('User is not logged in', async () => 
    {
        ...
        //no longer needed as we refactored it in the execRequests function used above
       /* test('Cannot make a blog post', async () =>
        {
        ...
        test('User cannot get a lsit of psots', async () =>
        {
